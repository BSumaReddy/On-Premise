"""
RECS Collection-1 Router — RECS_ONPREM_Asset_master_details

 POST /api/v1/recs/ingest/assets   Fetch from API-1 → Collection-1
 GET  /api/v1/recs/assets          List all assets
 GET  /api/v1/recs/assets/{id}     Single asset
"""
...
from on_premise.helpers.recs_helper import build_asset_master_doc
from on_premise.repository.recs_repo import AssetMasterRepository
...
router = APIRouter(prefix=ROUTER_PREFIXES["base"], tags=["Collection-1: Asset Master"])
...
async def ingest_assets(request: Request):
    ...
    **recs_onprem_asset_master_details** (Collection-1).
    ...
    - Stores mandatory fields at top level.
    - Sets `onprem_siem_tool`.
...
# ===========================================================================
# GET /recs/assets — list all assets
# ===========================================================================
...
# ===========================================================================
# GET /recs/assets/{details_id} — single asset
# ===========================================================================
